...
public class Tree2_3 <S extends Comparable<S>> {
    ...
    private node insertR(node current, S element) {
            ...
            if(!current.isNodeLeaf()) {
                ...
                } else if (current.leftKey.compareTo(element) > 0) { // The new element is smaller than the left element of the current node
                ...
                // Case: the pushed up element is bigger than the left element and less than the right element
                } else if (current.is2Node() || (current.is3Node() && current.rightKey.compareTo(element) > 0)) {
                ...
                } else if (current.is3Node() && current.rightKey.compareTo(element) < 0) {
                    ...
                    if (current.leftKey.compareTo(element) == 0 || (current.is3Node() && current.rightKey.compareTo(element) == 0)) {
                            ...
                            else if (current.leftKey.compareTo(element) < 0) current.rightKey = element;
                    }
    ...
    private node split(node current, S value){
        ...
        else if (current.leftKey.compareTo(value) < 0) {
        	// The new element is greater than the current's left only
        	if (current.rightKey.compareTo(value) > 0) {
